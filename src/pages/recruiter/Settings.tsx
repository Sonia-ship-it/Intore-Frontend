      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-5">
        ...
        <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4 border-b bg-muted/30">
            ...
            <h3 className="font-semibold text-sm">{t('settings.profile', 'Profile')}</h3>
          </div>
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="block text-sm font-medium">{t('settings.fullName', 'Full Name')}
              ...
              <label className="block text-sm font-medium">{t('settings.email', 'Email')}
            ...
            <div className="flex justify-end">
              <Button size="sm" className="gap-2"><Save className="h-3.5 w-3.5" /> {t('settings.saveChanges', 'Save Changes')}</Button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4 border-b bg-muted/30">
            ...
            <h3 className="font-semibold text-sm">{t('settings.appearance', 'Appearance')}</h3>
          </div>
          <div className="p-6 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium">{t('settings.theme', 'Theme')}</p>
              <p className="text-xs text-muted-foreground mt-0.5">Currently using {isDark ? t('settings.darkMode', 'dark') : t('settings.lightMode', 'light')} mode</p>
            </div>
            <button
              onClick={toggle}
        ...
        <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4 border-b bg-muted/30">
            ...
            <h3 className="font-semibold text-sm">{t('settings.notifications', 'Notifications')}</h3>
          </div>
          <div className="p-6 space-y-4">
            {[
        ...
        <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4 border-b bg-muted/30">
            ...
            <h3 className="font-semibold text-sm">{t('settings.security', 'Security')}</h3>
          </div>
          <div className="p-6 space-y-4">
            <label className="block text-sm font-medium">{t('settings.currentPassword', 'Current Password')}
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="block text-sm font-medium">{t('settings.newPassword', 'New Password')}
                <input type="password" placeholder="••••••••" className="mt-1 w-full rounded-xl border bg-background px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[#4B7BFF]/20 focus:border-[#4B7BFF] transition-all" />
              </label>
              <label className="block text-sm font-medium">{t('settings.confirmPassword', 'Confirm Password')}
                <input type="password" placeholder="••••••••" className="mt-1 w-full rounded-xl border bg-background px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[#4B7BFF]/20 focus:border-[#4B7BFF] transition-all" />
              </label>
            </div>
            <div className="flex justify-end">
              <Button size="sm" variant="outline">{t('settings.updatePassword', 'Update Password')}</Button>
            </div>
          </div>
        </div>
